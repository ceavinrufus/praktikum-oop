...
public class Fespa extends Motor{
    ...
    public String printDescription(){
        ...
        if (isRoundedFrontLamp) {
            return String.format("Motor ini memiliki %d roda dengan kapasitas mesin %d cc, memiliki warna %s, dan memiliki lampu depan berbentuk lingkaran", super.getNumberOfWheels(), super.getEngineCapacity(), color);
        } else {
            return String.format("Motor ini memiliki %d roda dengan kapasitas mesin %d cc, memiliki warna %s, dan memiliki lampu depan berbentuk persegi panjang", super.getNumberOfWheels(), super.getEngineCapacity(), color);
        }
    }
}