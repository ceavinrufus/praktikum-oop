...
public class Bus extends Car{//Jangan lupa tambahkan kata kunci untuk melakukan polymorphism antar kelas
    ...
    public String printDescription(){
        ...
        if (isUsedForLongTrip){
            return String.format("Mobil ini memiliki %d roda dengan kapasitas mesin %d cc, memiliki kapasitas penumpang %d orang, dan digunakan untuk perjalanan jauh", super.getNumberOfWheels(), super.getEngineCapacity(), passengerCapacity);
        } else {
            return String.format("Mobil ini memiliki %d roda dengan kapasitas mesin %d cc, memiliki kapasitas penumpang %d orang, dan tidak digunakan untuk perjalanan jauh", super.getNumberOfWheels(), super.getEngineCapacity(), passengerCapacity);
        }
    }
}
