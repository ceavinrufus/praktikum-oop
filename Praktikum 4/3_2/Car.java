...
public class Car {
    ...
    public String printDescription(){
        ...
        if (isRacingCar()){
            return String.format("Mobil balap ini memiliki %d roda dengan kapasitas mesin %d cc", numberOfWheels, engine.getEngineCapacity());
        } else {
            return String.format("Mobil ini memiliki %d roda dengan kapasitas mesin %d cc", numberOfWheels, engine.getEngineCapacity());
        }
    }
}
