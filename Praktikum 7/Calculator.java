public class Calculator {
    ...
    public double calculate(double a, double b, String operation) throws InvalidDivisionByZero, InvalidOperationException {
        /**
         * Implementasi
...
class InvalidOperationException extends java.lang.Exception {
    ...
    public String getMessage() {
        ...
        return String.format("Invalid operation: %s", operation);
    }
}

class InvalidDivisionByZero extends java.lang.Exception {
