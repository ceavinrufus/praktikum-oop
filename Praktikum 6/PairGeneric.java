...
public class PairGeneric<K,V> implements Pair<K,V>{
    ...
    public String getTypeKeyandValue(){
        ...
        return (String) (key + " memiliki tipe " + key.getClass().getSimpleName() + " dan value dari key tersebut memiliki tipe " + value.getClass().getSimpleName() + " dengan nilai berupa " + value);
    }
}